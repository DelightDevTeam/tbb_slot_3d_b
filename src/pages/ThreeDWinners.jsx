    ...
    <div className='px-2 ' style={{marginBottom:'150px'}} >
      ...
      <div className="row mb-4">
        {topWinners.map((winner)=>{
            return <div style={{ background:' rgb(227, 177, 14)',marginTop:winner.isMiddle?'-20px':''}} className="topWinnerCard rounded-4 col-4">
      ...
      <div className="my-4">
        {winnerLists.map((winner)=>{
            return <div style={{background:' rgb(227, 177, 14)'}} className='mb-3 p-2 rounded-4 d-flex flex-nowrap align-items-center justify-content-between gap-1 gap-sm-2'>
                <h6>{winner.id}</h6>
